...
func (x *SendCodeIn) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SendCodeIn) ProtoMessage() {}

func (x *SendCodeIn) ProtoReflect() protoreflect.Message {
	mi := &file_api_auth_proto_msgTypes[2]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SendCodeIn.ProtoReflect.Descriptor instead.
func (*SendCodeIn) Descriptor() ([]byte, []int) {
	return file_api_auth_proto_rawDescGZIP(), []int{2}
}

func (x *SendCodeIn) GetEmail() string {
	if x != nil {
		return x.Email
	}
	return ""
...
func (x *SendCodeOut) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SendCodeOut) ProtoMessage() {}

func (x *SendCodeOut) ProtoReflect() protoreflect.Message {
	mi := &file_api_auth_proto_msgTypes[3]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SendCodeOut.ProtoReflect.Descriptor instead.
func (*SendCodeOut) Descriptor() ([]byte, []int) {
	return file_api_auth_proto_rawDescGZIP(), []int{3}
}

func (x *SendCodeOut) GetUuid() string {
	if x != nil {
		return x.Uuid
	}
	return ""
...
var file_api_auth_proto_rawDesc = []byte{
	...
	0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x03, 0x6a, 0x77, 0x74, 0x32, 0x37, 0x0a, 0x0b, 0x41,
	...
	0x73, 0x65, 0x22, 0x00, 0x42, 0x0a, 0x5a, 0x08, 0x70, 0x6b, 0x67, 0x2f, 0x61, 0x75, 0x74, 0x68,
