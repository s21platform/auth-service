...
const (
	...
	AuthService_RefreshAccessToken_FullMethodName       = "/AuthService/RefreshAccessToken"
)
...
type AuthServiceClient interface {
	...
	RefreshAccessToken(ctx context.Context, in *RefreshAccessTokenIn, opts ...grpc.CallOption) (*RefreshAccessTokenOut, error)
}
...
func (c *authServiceClient) RefreshAccessToken(ctx context.Context, in *RefreshAccessTokenIn, opts ...grpc.CallOption) (*RefreshAccessTokenOut, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(RefreshAccessTokenOut)
...
type AuthServiceServer interface {
	...
	RefreshAccessToken(context.Context, *RefreshAccessTokenIn) (*RefreshAccessTokenOut, error)
...
func (UnimplementedAuthServiceServer) RefreshAccessToken(context.Context, *RefreshAccessTokenIn) (*RefreshAccessTokenOut, error) {
...
func _AuthService_RefreshAccessToken_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthServiceServer).RefreshAccessToken(ctx, req.(*RefreshAccessTokenIn))
	}
	return interceptor(ctx, in, info, handler)
}
