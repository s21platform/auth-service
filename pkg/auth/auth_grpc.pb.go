...
const (
	...
	AuthService_SendCode_FullMethodName = "/AuthService/SendCode"
)
...
type AuthServiceClient interface {
	...
	SendCode(ctx context.Context, in *SendCodeIn, opts ...grpc.CallOption) (*SendCodeOut, error)
}
...
func (c *authServiceClient) SendCode(ctx context.Context, in *SendCodeIn, opts ...grpc.CallOption) (*SendCodeOut, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(SendCodeOut)
...
type AuthServiceServer interface {
	...
	// Send verification code to email and save data into pending table
	SendCode(context.Context, *SendCodeIn) (*SendCodeOut, error)
...
func (UnimplementedAuthServiceServer) SendCode(context.Context, *SendCodeIn) (*SendCodeOut, error) {
...
func _AuthService_SendCode_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthServiceServer).SendCode(ctx, req.(*SendCodeIn))
	}
	return interceptor(ctx, in, info, handler)
}
